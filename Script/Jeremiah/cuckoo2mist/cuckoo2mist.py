...
os.chdir("/Users/Jeremiah/GitHub/CS-181-Practical-2/Script/Jeremiah/cuckoo2mist")
		...
		for seqReportRow in seqReportRows:
			while len(thlist) >= max_threads:
				...
				for t in thlist:
					...
					if not t.isAlive():
						thlist.remove(t)
			t = th_seq2mist(input_file=seqReportRow["seq_path"],
			elements2mist=e2m, types2mist=t2m, 
